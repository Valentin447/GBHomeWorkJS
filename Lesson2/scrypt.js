...
const num1 = prompt('Введите первую переменную');
const num2 = prompt('Введите вторую переменную');

if(num1 <= 1){
  alert('Первая переменная равна или меньше 1')
}
if(num2 >= 3){
  alert('Вторая переменная больше или равна 3')
}
...
alert(`В числе ${num} количество сотен: ${hundred}, десятков: ${ten}, единиц: ${one}`)
